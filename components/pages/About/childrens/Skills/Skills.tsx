...
export function Skills({ t }: SKillsProps) {
    ...
    const data = Object.entries(t('skills', { returnObjects: true })) as DataSkillsGroup[]
                        ...
                        <SkillsGroup key={title}>
                            <GroupTitle>{title}</GroupTitle>
                            {
                                isListWithoutSubGroups
                                    ...
                                    : (Object.entries(baseWords) as undefined as Group)
                                        .map(([title, baseWords], idx) => {
