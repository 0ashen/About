    ...
    return (
        <NextHead>
            ...
            <link
                ...
                sizes="180x180"
                href={`${faviconsBasePath}/apple-touch-icon.png`}
            />
            <link
                rel="icon"
                type="image/png"
                sizes="32x32"
                href={`${faviconsBasePath}/favicon-32x32.png`}
            />
            <link
                rel="icon"
                type="image/png"
                sizes="16x16"
                href={`${faviconsBasePath}/favicon-16x16.png`}
            />
            <link rel="manifest" href={'/site.webmanifest'} />
            <link
                rel="mask-icon"
                href={`${faviconsBasePath}/safari-pinned-tab.svg`}
                color="#5bbad5"
            />
